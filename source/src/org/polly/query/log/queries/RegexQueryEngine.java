...
/**
 * This implementation is used to match a query that is a regex.
 * 
 * @author Alessandro Pollace
 */
public class RegexQueryEngine implements IQueryEngine {
	private String query = "";

	private static final String TOKEN = "regex:";
	...
	public boolean setQuery(String query) {
		...
		this.query = query.substring(TOKEN.length());
		return false;
	}

	@Override
	public boolean match(String line) {
		return line.matches(query);
	}
